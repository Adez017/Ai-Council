      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          <div className="mb-8 inline-flex items-center rounded-full border bg-muted px-4 py-1.5 text-sm">
            ...
            <span className="font-medium">Multi-Provider AI Orchestration</span>
          </div>
          ...
          <p className="mx-auto mb-10 max-w-2xl text-lg text-muted-foreground sm:text-xl">
            AI Council breaks down complex queries and distributes them across multiple specialized AI providers, 
            delivering better results at lower costs through parallel processing and intelligent orchestration.
          </p>
          
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Button size="lg" className="w-full sm:w-auto" onClick={scrollToDemo}>
              Try Demo
